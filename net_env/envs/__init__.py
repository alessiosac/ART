...
register(id = "net-v1", entry_point = "net_env.envs:NetEnv", kwargs = {'nports' : 5, "id":"s1", "port": 50051})
...
register(id = "net-v6", entry_point = "net_env.envs:NetEnv", kwargs = {'nports' : 5, "id":"s6", "port": 50056})
register(id = "net-v7", entry_point = "net_env.envs:NetEnv", kwargs = {'nports' : 5, "id":"s7", "port": 50057})
register(id = "net-v8", entry_point = "net_env.envs:NetEnv", kwargs = {'nports' : 5, "id":"s8", "port": 50058})
# simple topology env
register(id = "net-v9", entry_point = "net_env.envs:NetEnv", kwargs = {'nports' : 5, "id":"s9", "port": 50059})
